...
const plannerPrompt_1 = require("../prompts/plannerPrompt");
...
async function runPlannerAgent(input, onToken, token, modelId) {
    let model;
    if (modelId) {
    ...
    const systemPrompt = "You are CLAUDE role: a precise software architecture planner and final reviewer for hackathon delivery.";
    const userPrompt = (0, plannerPrompt_1.buildPlannerPrompt)(input);
